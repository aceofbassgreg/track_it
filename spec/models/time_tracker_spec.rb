...
describe TimeTracker do
  describe "clock able validation" do
    ...
    it "should not clock out if there are no records in the database" do
      time_tracker = build(:time_tracker,clock_in: nil)
      time_tracker.valid?
    ...
    it "should not clock in if the previous record is not clocked out" do 
      create(:time_tracker,clock_out: nil)
      time_tracker = build(:time_tracker, clock_out: nil)
      time_tracker.valid?
    ...
    it "is invalid without both clock in and clock out empty" do 
      time_tracker = build(:time_tracker, clock_in: nil, clock_out: nil)
      time_tracker.valid?
    ...
    it "is invalid withouth date" do
      time_tracker = build(:time_tracker, date: nil)
      time_tracker.valid?
      time_tracker.errors[:present].should include present_error
    end
  end
